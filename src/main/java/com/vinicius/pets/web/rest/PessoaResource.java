...
/**
 * REST controller for managing {@link com.vinicius.pets.domain.Pessoa}.
 */
@RestController
@RequestMapping("/api")
public class PessoaResource {
     ...
     */
    @GetMapping("/pessoas")
    public ResponseEntity<List<PessoaDTO>> getAllPessoas(PessoaCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
