...
/**
 * REST controller for managing {@link com.vinicius.pets.domain.Pet}.
 */
@RestController
@RequestMapping("/api")
public class PetResource {
     ...
     */
    @GetMapping("/pets")
    public ResponseEntity<List<PetDTO>> getAllPets(PetCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
